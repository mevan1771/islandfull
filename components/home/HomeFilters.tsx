...
export function HomeFilters({ dynamicCategories = [] }: { dynamicCategories?: any[] }) {
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 mt-8 md:mt-16 mb-6 md:mb-8 text-zinc-900">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 md:gap-4">
          ...
          <div className="flex items-center justify-end w-full md:w-auto">
            <div className="flex items-center gap-2 px-4 py-2 border border-zinc-200 rounded-full bg-white text-sm font-medium text-zinc-700 w-full md:w-auto justify-between md:justify-start shadow-sm">
