...
export function HeroCarousel({ tours, introSlide }: { tours: Tour[], introSlide?: any }) {
  ...
  return (
    <section className="relative pt-24 md:pt-32 pb-40 md:pb-48 text-white min-h-[50svh] md:min-h-[85vh] flex flex-col justify-center overflow-hidden rounded-b-xl md:rounded-none bg-slate-200 animate-in fade-in duration-700 ease-in-out">
      {/* Slides */}
