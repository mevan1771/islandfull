...
export function HeroCarousel({ carouselSlides }: { carouselSlides: Tour[] }) {
    ...
    return (
        <section className="relative pt-24 md:pt-32 pb-40 md:pb-48 text-white h-[50svh] md:h-[85vh] flex flex-col justify-center overflow-hidden rounded-b-xl md:rounded-none bg-slate-900">
