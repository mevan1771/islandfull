    ...
    <header className="absolute top-0 md:top-6 left-0 right-0 z-40 w-full pt-4">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link href="/map" className="flex items-center gap-1.5 px-3 md:px-6 py-2 md:py-2.5 bg-white/20 hover:bg-white/30 backdrop-blur-md border border-white/20 text-white text-sm font-bold rounded-full transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(255,255,255,0.1)]">
            🌍 <span className="hidden md:inline">Explore Map</span>
          </Link>
