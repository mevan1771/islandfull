...
export async function createTour(formData: FormData) {
  try {
    ...
    const price_lkr_approx = parseFloat(formData.get("price_lkr_approx") as string)
    ...
    if (!title || !category_id || !location || !description || !duration || !price_usd || !price_lkr_approx || !cover_image_url || !max_capacity) {
