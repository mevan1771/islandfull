  ...
  return (
    <div className="w-full flex flex-col min-h-screen bg-zinc-50 relative pt-[80px]">
      <div className="flex-1 flex flex-col lg:flex-row max-w-7xl mx-auto w-full px-4 gap-6">
        ...
        <div 
          className={`w-full lg:w-[55%] flex-col overflow-y-auto h-[calc(100vh-80px)] pb-24 lg:pr-4 relative z-10
                ...
                <section key={group.title}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-[220px]">
                    {group.destinations.map((dest, index) => {
                      ...
                      return (
                        <Link 
                          href={`/destinations/${dest.id.toLowerCase()}`}
                          key={dest.id} 
                          className={`group relative rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 block bg-zinc-900
                        ...
                        >
                          ...
                          <div className="absolute bottom-0 left-0 w-full p-6 flex flex-col justify-end pointer-events-none">
                            ...
                            <div className="inline-block bg-white/20 backdrop-blur-md border border-white/20 rounded-full px-3 py-1 text-xs font-semibold text-white w-max pointer-events-auto">
