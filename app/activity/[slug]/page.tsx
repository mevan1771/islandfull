...
export default async function ActivityPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="bg-white min-h-screen pb-32 md:pb-12">
      {/* Hero Image */}
      <div className="relative h-[35vh] md:h-[500px] m-3 sm:m-0 md:mx-auto md:w-full md:mt-6 max-w-[1400px] rounded-2xl sm:rounded-3xl overflow-hidden shadow-lg md:shadow-2xl">
        {/* Mobile Back Button */}
