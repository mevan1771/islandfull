...
const oldTimer = `<CountdownTimer targetDate={dealEndDate} onExpire={() => setIsDealActive(false)} />`;
const newTimer = `<CountdownTimer targetDate={dealEndDate} />`;

content = content.replace(oldTimer, newTimer);

fs.writeFileSync(filePath, content, 'utf8');
console.log('Successfully fixed ActivityCard.tsx logic and UI');
